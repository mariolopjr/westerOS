...
# Build ISO
[group('ISO')]
build-iso image="bazzite" ghcr="0" clean="0":
    #!/usr/bin/env bash
    set ${SET_X:+-x} -eou pipefail
    # Validate
    declare -A images={{ images }}
...
merge-changelog:
    ...
    cat changelog-bazzite.md > changelog.md
